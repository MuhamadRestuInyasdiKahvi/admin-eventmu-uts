            ...
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Grafik Event</h6>
                    </div>
                    <div class="card-body p-3">
                        <?php
                        $hostdb = "localhost";
                        ...
                        $strQuery = "SELECT *, COUNT(id) AS jml_event FROM tb_event GROUP BY(tanggal) ORDER BY tanggal ASC";
                        ...
                        if ($result) {
                            $arrData = array(
                                "chart" => array(
                                    "caption" => "Jumlah Event Berdasarkan Tanggal",
                                    "showValues" => "0",
                                    "theme" => "fusion"
                                )
                            );
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                array_push(
                                    $arrData["data"],
                                    array(
                                        "label" => date('D, d-m-Y', strtotime($row["tanggal"])),
                                        "value" => $row["jml_event"]
                                    )
                                );
                            }
